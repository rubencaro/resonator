defmodule Resonator.Cover do
  ...
  def project do
    [app: :resonator,
     ...,
     test_coverage: [tool: Resonator.Cover, ignored: [Resonator.Helpers]],
     aliases: aliases]
  end
  ```
  ...
  defp get_results(opts) do
    ...
    %Resonator.Cover{rate: rate, not_covered: nc, errors: fail, opts: opts}
  end
  ...
  defp format_results(%Resonator.Cover{} = data) do
